...
const AreaOfExpertise = ({ imageSrc, title }) => {
    return (
      <div
        className="flex m-2 p-2 flex-col w-1/2 sm:w-1/3 lg:w-1/4 max-md:w-1/2 max-md:ml-0 max-md:w-full relative"
        style={{
          height: "520px",
          minHeight: "480px",
      ...
      >
        <div
          className="bg-cover p-2 bg-center min-h-[180px] overflow-hidden flex-grow px-7 pb-8 
          text-2xl font-medium leading-10 
          text-center text-white rounded max-md:px-5 max-md:pt-10 max-md:mt-6"
          style={{ backgroundImage: `url(${imageSrc})` }}
        >
            {/* bg-black bg-opacity-50  */}
          <div className="absolute m-2 bottom-0 left-0 right-0 p-4 
...
const ExpertiseSection = () => {
  return (
    <section
      id="expertise"
      className="flex flex-col px-10 mt-28 w-full max-md:px-5 max-md:mt-10 max-md:max-w-full"
    >
